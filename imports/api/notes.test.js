...
if (Meteor.isServer) {
  describe('notes', function () {
    ...
    it('should throw error if extra updates provided', function () {
      expect(() => {
        Meteor.server.method_handlers['notes.updaate'].apply({
          userId: noteOne.userId
        }, [
          noteOne._id,
    ...
    it('should return a zero notes for a user that has none', function() {
    const res =  Meteor.server.publish_handlers.notes.apply({ userId: 'Andrew' });
    const notes = res.fetch();
